...
public class Factura {
    public static class NAMES {
        public static String TABLE_NAME = "tab_factura";
        ...
        public static String web_fac = "web_fac";
        public static String imp_fac = "imp_fac";
        public static String fac_fis = "fac_fis";
        public static String usu_fac = "usu_fac";
        public static String dol_fac = "dol_fac";
    }
    private int cod_fac;
    ...
    private int web_fac;
    private int imp_fac;
    private String fac_fis;
    private String usu_fac;
    private double dol_fac;
}
